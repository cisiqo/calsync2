...
# MySQL > Database name
define("PROJECT_DB_MYSQL_DBNAME", "baikal2");

# MySQL > Username
define("PROJECT_DB_MYSQL_USERNAME", "root");

# MySQL > Password
define("PROJECT_DB_MYSQL_PASSWORD", "marlin");

# A random 32 bytes key that will be used to encrypt data
define("BAIKAL_ENCRYPTION_KEY", "696edb33e0860d3e14a23255d82f3f29");

# The currently configured Baïkal version
define("BAIKAL_CONFIGURED_VERSION", "0.2.4");